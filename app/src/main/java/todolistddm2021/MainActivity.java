...
import todolistddm.R;
import todolistddm2021.task_database.TaskContract;
import todolistddm2021.task_database.TaskDatabaseHelper;
        ...
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                AlertDialog dialog = new AlertDialog.Builder(this)
                        .setTitle("Adicionar nova tarefa").setMessage("o que quer fazer a seguir?").setView(taskEdit)
